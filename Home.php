...
<div class="prof">
   ...
   <label for="name">Kenneth Barinas</label>   
</div>
    </div>
</nav>
	...
	<div class="dashboard bg-danger">
	  ...
	  <ul class="link-group">
	    <li><a href="./Admin/SignIn.html"><i class="fa fa-group"></i>Employees</a></li>
	    <li><a href="../Admin/Working_days.php"><i class="fa fa-group"></i>Working Days</a></li>
...
<li><a href="./Admin/SignIn.html"><i class="fa fa-sign-out"></i>Logout</a></li>
	...
	<div class="container">
	 <img class="back_pages" src="./img/back_pages.png" alt="back_pages" /> 
<?php
