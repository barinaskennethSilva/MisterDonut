...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.min.js" integrity="sha384-cVKIPhGWiC2Al4u+LWgxfKTRIcfu0JTxR+EQDz/bgldoEyl4H0zUF0QKbrJ0EcQF" crossorigin="anonymous"></script>
  ...
  <body>
   <nav class="navbar navbar-danger bg-danger">
       ...
       <label class="fw-bold text-white me-3"><?php echo $row['ad_name'];?></label>
   </nav> 
 ...
 <div class="w-100 p-2 bg-danger text-white">
  ...
  <form class="p-3" method="post" action="Verify_loginForm.php">

  <div class="mb-3">
    <input type="password" class="form-control text-center" id="password" name="verify-input" required autocomplete="off">
  </div>
